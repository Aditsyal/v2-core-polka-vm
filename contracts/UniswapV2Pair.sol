...
// Fixed-point library for price calculations
library UQ112x112 {
...
// Math library with sqrt function
library Math {
...
contract UniswapV2Pair is IUniswapV2Pair, UniswapV2ERC20 {
    ...
    event MintPair(address indexed sender, uint amount0, uint amount1);
    event BurnPair(address indexed sender, uint amount0, uint amount1, address indexed to);
    event SwapPair(
        address indexed sender,
        uint amount0In,
        uint amount1In,
    ...
    event SyncPair(uint112 reserve0, uint112 reserve1);

    constructor(address _token0, address _token1) {
        // Set tokens in sorted order
